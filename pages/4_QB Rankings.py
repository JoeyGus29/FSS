...
st.title("Rescaled FSS Rankings – QB Rankings")

csv_file = "qb_fss_rankings.csv"
...
try:
    ...
    if df.empty:
        ...
        st.download_button(
            label="Download QB FSS (Rescaled 50–99) CSV",
            data=csv_bytes,
            file_name="qb_fss_rescaled.csv",
            mime="text/csv"
        )
