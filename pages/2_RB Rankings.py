...
st.title("Rescaled FSS Rankings – RB Rankings")

csv_file = "rb_fss_rankings.csv"
...
try:
    ...
    if df.empty:
        ...
        st.download_button(
            label="Download RB FSS (Rescaled 50–99) CSV",
            data=csv_bytes,
            file_name="rb_fss_rescaled.csv",
            mime="text/csv"
        )
